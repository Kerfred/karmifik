	...
	function filter_user_verified(WP_User_Query $user_query)
	{
		...
		function register_notice() {
			...
			if ($pagenow == 'admin.php' && $_GET['page'] == 'peepso') {
				...
				{
					$dashboard_main = PeepSoRemoteContent::get('peepso_option_dashboard_main', 'optin_dashboard_main.txt');
					$dashboard_info = PeepSoRemoteContent::get('peepso_option_dashboard_info', 'optin_dashboard_info.txt');
					?>
